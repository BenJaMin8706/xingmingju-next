...
const skills: Skill[] = [
  ...
  },
  {
    ...
    image: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200' fill='none'%3E%3Crect width='200' height='200' rx='16' fill='%23fef7ed'/%3E%3Ccircle cx='100' cy='75' r='32' fill='%23f8d98a' opacity='0.6'/%3E%3Ccircle cx='100' cy='75' r='18' fill='%23c89433' opacity='0.3'/%3E%3Cellipse cx='100' cy='145' rx='40' ry='35' fill='%23f8d98a' opacity='0.5'/%3E%3Ctext x='100' y='82' text-anchor='middle' fill='%239d671e' font-size='28' font-family='sans-serif'%3E宝%3C/text%3E%3Ctext x='100' y='165' text-anchor='middle' fill='%237d5a2e' font-size='13' font-family='sans-serif'%3E起名%3C/text%3E%3C/svg%3E",
    imageMode: "contain-image",
    rating: "4.9",
    users: "3万+",
    discount: "13%",
  ...
  },
  {
    ...
    image: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200' fill='none'%3E%3Crect width='200' height='200' rx='16' fill='%23f0f4ff'/%3E%3Crect x='40' y='44' width='120' height='62' rx='10' fill='%233b82f6' opacity='0.2'/%3E%3Crect x='50' y='52' width='100' height='46' rx='6' fill='%23fff' stroke='%233b82f6' stroke-width='2'/%3E%3Ctext x='100' y='82' text-anchor='middle' fill='%231d4ed8' font-size='22' font-weight='900' font-family='sans-serif'%3E京A%3C/text%3E%3Ctext x='100' y='105' text-anchor='middle' fill='%233b82f6' font-size='28' font-weight='900' font-family='sans-serif'%3E88888%3C/text%3E%3Ctext x='100' y='170' text-anchor='middle' fill='%2364748b' font-size='12' font-family='sans-serif'%3E车牌测吉凶%3C/text%3E%3C/svg%3E",
    imageMode: "contain-image",
    rating: "4.7",
    users: "5万+",
    discount: "17%",
  ...
  },
  {
    ...
    image: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200' fill='none'%3E%3Crect width='200' height='200' rx='16' fill='%23f5f3ff'/%3E%3Crect x='68' y='30' width='64' height='116' rx='10' fill='%237c3aed' opacity='0.15'/%3E%3Crect x='72' y='36' width='56' height='104' rx='8' fill='%23fff' stroke='%237c3aed' stroke-width='2'/%3E%3Ccircle cx='100' cy='132' r='8' stroke='%237c3aed' stroke-width='2'/%3E%3Ctext x='100' y='82' text-anchor='middle' fill='%236d28d9' font-size='30' font-family='sans-serif'%3E📱%3C/text%3E%3Ctext x='100' y='175' text-anchor='middle' fill='%2364748b' font-size='12' font-family='sans-serif'%3E手机号测吉凶%3C/text%3E%3C/svg%3E",
    imageMode: "contain-image",
    rating: "4.8",
    users: "8万+",
    discount: "17%",
